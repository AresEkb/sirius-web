...
public enum ArrowStyle implements Enumerator {
    ...
    /**
     * The '<em><b>Slash</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #SLASH_VALUE
     * @generated
     * @ordered
    ...
    /**
     * The '<em><b>Slash</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @see #SLASH
     * @model name="Slash"
     * @generated
